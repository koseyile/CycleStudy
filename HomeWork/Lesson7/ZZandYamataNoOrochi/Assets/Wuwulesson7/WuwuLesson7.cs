...
public class WuwuLesson7 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        firebird = new Role() { attack = 15, blood = 520, criticaldamage = 3 * 15 };
    ...
    public void Fight(ref Role snake,ref Role firebird,ref Image Gas, ref Image Fire,ref Image ZZ, ref Image Wapon, ref Image Wow, ref Image White, ref Image SnakeAsh, ref Image Snake, ref Image Gold)
    {
    ...
    public void Whitefade(ref Image White, ref Image Snake, ref Image SnakeAsh, ref Image Gold)
    {
        ...
        switch (whitecurrentstate)
        {
            case Whitestate.fadein:
                {
                    //9. “哇！”声之后，整个画面fade in到白屏，白屏显示3秒，再fade out出来，fade的过程都是2秒，请使用状态机实现此过程。但是感觉是一个固定的值，不会变
                    float fadein = 0.0f;
                    fadein += 0.8f* whitecurrentime;
                    White.color = new Color(1, 1, 1, fadein);
            ...
            case Whitestate.iswhite:
                {
                    if (whitecurrentime > 3.0f)
                    {
                        ...
                        whitecurrentstate = Whitestate.fadeout;
                        whitecurrentime = 0;
                        Debug.Log("白屏3秒");
                    }
                }
            ...
            case Whitestate.fadeout:
                {
                    float fadeout = 0.0f;
                    fadeout += 0.8f * whitecurrentime;
                    White.color = new Color(1, 1, 1, 1 - fadeout);
                    if (whitecurrentime >2.0f)
                    {
    ...
    void Update()
    {
        ...
        ////题3-10
        Fight(ref snake, ref firebird, ref Gas, ref Fire,ref ZZ, ref Wapon, ref Wow, ref White, ref SnakeAsh, ref Snake, ref Gold);
    }
}
